...
describe("e2e/32-autoxhr-spa/19-click-img-click-xhr-img.js", function() {
	...
	describe("Beacon 2", function() {
		...
		it("Should have Page Load Time ~4000ms", function() {
			assert.closeTo(tf.beacons[1].t_done, t.xhrTimes.xhr1.duration + t.imgTimes.img2.duration, 100);
		});
		...
		it("Should have Front End Time ~2000ms", function() {
			assert.closeTo(tf.beacons[1].t_page, t.imgTimes.img2.duration, 100);
		});
	});
});
