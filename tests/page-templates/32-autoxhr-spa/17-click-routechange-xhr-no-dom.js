...
describe("e2e/32-autoxhr-spa/17-click-routechange-xhr-no-dom.js", function() {
	...
	describe("Beacon 2", function() {
		...
		it("Should have Page Load Time ~2030ms", function() {
			assert.closeTo(tf.beacons[1].t_done, t.xhrTimes.xhr1.duration + 30, 100);
		});
		...
		it("Should have Front End Time ~30ms", function() {
			assert.closeTo(tf.beacons[1].t_page, 30, 50);
		});
	});
});
