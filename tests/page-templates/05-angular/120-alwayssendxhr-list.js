...
describe("e2e/05-angular/120-alwayssendxhr-list.js", function() {
	...
	it("Should have sent the first beacon with a URL of the page", function() {
		assert.isTrue(tf.beacons[0].u.indexOf("120-alwayssendxhr-list") !== -1);
	});
	...
	it("Should have sent the second beacon with a Page URL of the app", function() {
		assert.isTrue(tf.beacons[1].pgu.indexOf("120-alwayssendxhr-list") !== -1);
	});
	...
	it("Should have sent the fourth beacon with a URL of the page", function() {
		assert.isTrue(tf.beacons[3].u.indexOf("120-alwayssendxhr-list") !== -1);
	});
